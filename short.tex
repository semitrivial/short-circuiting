...
should satisfy any particular axiom, rather, our objective is to clarify (using
Definitions \ref{maindef} and \ref{maindefextension}) what it means for an AGI to
satisfy said axiom---to clarify it in a way which is independent of the AGI's own
internal definition of knowledge.
