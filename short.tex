...
define things. More on this in Subsection \cite{noncircularsubsection}.
...
\begin{itemize}
  ...
  $(x=0)\wedge \exists x(x=1)$. This defines $x$ as $0$. The subformula
  ...
  output an error message or say the result is undefined. For any calculator $X$, it
